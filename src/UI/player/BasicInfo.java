...
public class BasicInfo extends JPanel {
	...
	/**	
		...
		*/
		...
		//投篮命中率
		ImageIcon info_1 = new ImageIcon("pic\\1-100\\投篮命中率.png"); 
		...
		ImageIcon percent_1 = new ImageIcon("pic\\1-100\\命中率_"+getpicturename(pvo.getData().getShootPercentage())+".png"); 
		...
		ImageIcon info_2 = new ImageIcon("pic\\1-100\\三分命中率.png"); 
		...
		ImageIcon info_3 = new ImageIcon("pic\\1-100\\罚球命中率.png"); 
		...
		add(info3);
		//罚球命中率
		ImageIcon percent_3 = new ImageIcon("pic\\1-100\\命中率_"+getpicturename(pvo.getData().getFreeThrowPercentage())+".png"); 
		...
		*/
		...
		ImageIcon imagebg = new ImageIcon("pic\\球员背景.png"); 
