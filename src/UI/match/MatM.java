...
public class MatM extends JPanel {
	...
	public MatM(String team, String date) {
		...
		JLabel label = new JLabel("客队队员信息："+mvo.getGuestTeam().getTeamName());
	...
	Object[][] getdata(ArrayList<SingleMatchPersonalDataVO> da){
		...
		if (da == null) {
			...
			Object[][] re = new Object[da.size()][18];
			for (int i = 0; i < da.size(); i++) {
				...
				re[i][16] = da.get(i).getPointNum();
				re[i][17] = da.get(i).getFoulNum();
			}
			return re;
